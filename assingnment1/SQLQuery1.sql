...
create table orders(ord_no int,purch_amt decimal(8,2),ord_date date,customer_id int,salesman_id int foreign key references Salesman(salesman_id))
...
create table customer(customer_id  int,cust_name varchar(50),city varchar(100),grade decimal(5,2),salesman_id int)
